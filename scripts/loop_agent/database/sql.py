"""Canonical SQL used by schema creation and migrations.

These statements intentionally remain explicit instead of being generated by
an ORM. Operators can compare them directly with SQLite metadata while
investigating an initialization or migration failure.
"""
