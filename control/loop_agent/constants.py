...
SCHEMA_USER_VERSION = 31000
AUTOMATIC_SPLIT_SCHEMA_USER_VERSION = 30900
WORKER_QUEUE_SCHEMA_USER_VERSION = 30800
SCHEDULING_SCHEMA_USER_VERSION = 30700
...
PREFLIGHT_STATUSES = ("UNINSPECTED", "QUEUED", "INSPECTING", "READY", "FAILED")
LOCK_MODES = ("file", "module", "project")
EXECUTION_POLICIES = ("automatic", "manual")
# 新任务和新 execution 只允许系统能够自行启动、监管和恢复的内部运行环境。
CANONICAL_RUNTIME_ENVIRONMENTS = ("self_hosted_agent", "codex_cli")
